                                ...
                                <div class="position-relative border radius-16 overflow-hidden">
                                    ...
                                    <form action="{{ route('update-service') }}" method="POST" class="ps-16 pb-16 pe-16 text-center mt--50">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input disabled id="myInput1{{ $service->id }}" value={{ $cours->name }} style="background-color: transparent; border-color: transparent; font-size: 22px; font-weight: bold;" type="text" name="name" class="form-control form-control-lg" placeholder="Entrer le nom du cours">
                                        </div>
